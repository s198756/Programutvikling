...
/**
 * Created by sebastianramsland on 13.05.14.
 */
/**
...
public class PersonUITest extends JPanel {
    JFrame personFrame;
    ...
    public PersonUITest() throws SQLException {
    ...
    public PersonUITest(String pNo) throws SQLException {
    ...
    public PersonUITest(SQLInterface dbInt, FilteredRowSet frs, int rowID) throws SQLException {
    ...
    public PersonUITest(SQLInterface dbInt, CachedRowSetImpl crs, int rowID) throws SQLException {
